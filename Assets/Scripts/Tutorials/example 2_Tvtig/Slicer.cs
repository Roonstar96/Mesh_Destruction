...
namespace Assets.Scripts
{
    class Slicer
    {
        ...
        public static GameObject[] Slice(Plane plane, GameObject objectToCut)
        {
            ...
            SlicerMetadata slicesMeta = new SlicerMetadata(plane, mesh, sliceable.IsSolid, sliceable.ReverseWireTriangles, sliceable.ShareVertices, sliceable.SmoothVertices);
