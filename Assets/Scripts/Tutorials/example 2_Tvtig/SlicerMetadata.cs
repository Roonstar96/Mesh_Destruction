...
namespace Assets.Scripts
{
    ...
    class SlicerMetadata
    {
        ...
        public SlicerMetadata(Plane plane, Mesh mesh, bool isSolid, bool createReverseTriangleWindings, bool shareVertices, bool smoothVertices)
        {
